...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl glass-vibrant p-1 text-muted-foreground shadow-cosmic",
      className
    )}
    {...props}
  />
