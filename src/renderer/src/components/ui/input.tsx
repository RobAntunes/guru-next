  ...
  return (
    <input
      ...
      className={cn(
        ...
        "shadow-cosmic transition-all duration-400 outline-none",
        "hover:border-foreground/20 hover:shadow-cosmic-lg",
        "focus:border-foreground/40 focus:ring-2 focus:ring-foreground/20 focus:shadow-cosmic-lg neon-glow",
