...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-border/50 bg-card/60 backdrop-blur-xl text-card-foreground shadow-luxury transition-all duration-300 hover:shadow-luxury-lg hover:border-border/80 relative overflow-hidden",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl font-light leading-tight tracking-tight relative z-10",
      className
    )}
    {...props}
  />
